...
public class OpenBoxTests extends BinarySearchBase {
    ...
    void foundImmediateMid() {
        ...
        int index = BinarySearch.binarySearchImplementation(arr, 5);
    ...
    void goLeftThenFind() {
        ...
        int index = BinarySearch.binarySearchImplementation(arr, 4);
        assertEquals(4, arr[index]);
    }
    ...
    void goRightThenFind() {
        ...
        int index = BinarySearch.binarySearchImplementation(arr, 12);
        assertEquals(12, arr[index]);
    }
}
